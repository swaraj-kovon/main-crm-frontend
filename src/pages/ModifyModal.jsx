        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-40 flex justify-end" onClick={onClose} >
            <div className={`h-full w-full ${type === 'application' ? 'max-w-5xl' : 'max-w-lg'} bg-gray-100 shadow-xl z-50`} onClick={e => e.stopPropagation()}>
                <div className="flex h-full">
                    ...
                    <div className={`${type === 'application' ? 'w-1/2' : 'w-full'} p-6 flex flex-col bg-white`}>
                        ...
                        <div className="space-y-4 mb-8">
                            ...
                            {(type === 'user' || !record.targetCountry) && (
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Target Country (add if missing)</label>
                                    <input
                                        list="countries-list"
                            ...
                            {(type === 'user' || !record.targetJobRole) && (
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Target Job Role (add if missing)</label>
                                    <input
                                        list="jobroles-list"
                                        className="w-full p-2 border rounded"
                                        placeholder="Type to search for a job role..."
